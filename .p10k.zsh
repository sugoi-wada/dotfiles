# Generated by Powerlevel10k configuration wizard on 2020-05-29 at 17:06 JST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 64032.
# Wizard options: compatible, unicode, lean_8colors, 24h time, 2 lines, solid, no frame,
